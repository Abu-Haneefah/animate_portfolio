...
const saluteImgContainer = document.querySelector(".salauteImgContainer");
...
window.addEventListener("scroll", ()=>{
    ...
    jobTitles[0].style.transform = `translateX(cal(200vh - ${offsetY}))`
    jobTitles[1].style.transform = `translateX(cal(-300vh - ${offsetY}))`
